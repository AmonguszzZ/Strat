...
-- // ui
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/HiddenUsernames/Amongus/refs/heads/main/Stuff/UI.lua"))()
        ...
        while Globals.AutoGatling do
            if GameState == "GAME" then
                if not GatlingExecuted then
                    ...
                    task.spawn(function()
                        pcall(function()
                            loadstring(game:HttpGet("https://raw.githubusercontent.com/HiddenUsernames/Amongus/refs/heads/main/Stuff/Gatling.lua"))()
                        end)
                    end)
                end
            else
